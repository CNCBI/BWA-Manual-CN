...
You can read the Chinese translation of the manual page of BWA at [here](http://cncbi.github.io/BWA-Manual-CN/).

你可以在[这里](http://cncbi.github.io/BWA-Manual-CN/)查阅BWA使用手册的中文翻译。
